            ...
            <div class="col">
                ...
                <div class="row">
                    <div class="col modifier-categorie">
                        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editCategoryModal">Modifier une categorie</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col ajouter-article">
                        <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addArticleModal">Ajouter un article</button>
                    </div>
                </div>
            </div>
        </div>
